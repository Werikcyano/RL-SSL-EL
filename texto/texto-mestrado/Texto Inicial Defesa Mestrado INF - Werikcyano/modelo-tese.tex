...
\usepackage{amsmath} 
\usepackage{pdfpages}
\usepackage[authoryear]{natbib}  % para usar a bibliografia com números na citacao
\usepackage[breaklinks=true]{hyperref}  % para permitir quebra de linha em URLs
...
\includepdf[pages=-, scale=1, angle=0,  offset=0 -50]{pre/TECA_preenchido_werikcyano.pdf}
\rosto   % Primeira folha interna do trabalho
\includepdf[pages=-, scale=1, angle=0,  offset=0 -50]{pre/ficha_catalografica_werikcyano_corrigida.pdf}
