...
\begin{figure}[H]
    ...
    \caption{Comparativo da média de resets por episódio: Selfplay após Curriculum e Full Selfplay}
...
\begin{figure}[H]
    ...
    \caption{Comparativo do tempo médio entre resets: Selfplay após Curriculum e Full Selfplay}
...
\begin{figure}[H]
    ...
    \caption{Comparativo da duração média dos episódios: Selfplay após Curriculum e Full Selfplay}
...
Uma observação importante que sruge da análise dos dados dos torneios é o claro trade-off entre as diferentes abordagens de treinamento. A Tabela \ref{tab:comparacao_abordagens_detalhada} resume as principais métricas para cada abordagem nos confrontos diretos, facilitando a visualização destes trade-offs.
...
\begin{figure}[H]
    ...
    \caption{Comparativo da entropia da política: Selfplay após Curriculum e Full Selfplay}
...
\begin{figure}[H]
    ...
    \caption{Comparativo da perda da política: Selfplay após Curriculum e Full Selfplay}
...
\begin{figure}[H]
    ...
    \caption{Comparativo da variância explicada da função valor: Selfplay após Curriculum e Full Selfplay}
...
Esta seção analisa sucintamente o desempenho dos agentes em cada estágio do curriculum e sua transição para o self-play, complementando os resultados já apresentados.
