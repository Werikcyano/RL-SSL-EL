...
\begin{enumerate}
    ...
    \item \textbf{Eficiência computacional}: A redução de aproximadamente 40\% no tempo total de treinamento (7,4 horas versus 12,1-12,4 horas) demonstra ganho significativo de eficiência, fator crítico para aplicações práticas.
