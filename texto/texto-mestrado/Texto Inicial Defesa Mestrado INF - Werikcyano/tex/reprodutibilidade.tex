...
$$D_{azul} = \{d_1, d_2, d_3\}$$ para o time azul (time em treinamento) e $$D_{amarelo} = \{d_4, d_5, d_6\}$$ para o time amarelo (oponentes).
...
\subsubsection{Resultados e Eficácia do Curriculum}
